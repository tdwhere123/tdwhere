    ...
    <section className="mx-auto max-w-shell px-5 py-[clamp(72px,12vh,128px)] md:px-10">
      ...
      <div className="mt-10 grid gap-6 md:grid-cols-2 md:gap-10">
        ...
        <InkReveal delay={0.05}>
          <div className="relative h-full overflow-hidden bg-museum-stone/80 p-7 md:p-9">
            <motion.span
              aria-hidden="true"
        ...
        <InkReveal delay={0.2}>
          <div className="flex h-full flex-col justify-center p-1 md:p-4">
            <h3 className="font-mono text-xs font-medium uppercase tracking-[0.14em] text-faint">
              {c.moveTitle}
            </h3>
            <p className="mt-4 font-serif text-h3 leading-relaxed text-ink">{c.move}</p>
          </div>
        </InkReveal>
      </div>
