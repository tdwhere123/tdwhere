...
const en: Content = {
  ...
  hero: {
    ...
    vertical: 'PROCESS · MEMORY · WRITING',
    chips: ['3 big projects', '1 ruin', 'a deck of veggie cards'],
    scroll: 'SCROLL',
  },
  thread: {
  ...
  quotes: [
    ...
    '“Similarity is not truth.”',
    '“The agent proposes, the gate decides.”',
    '“done” is evidence, not a mood.',
    '“Route before you write.”',
    '“Built after hours, taken seriously.”',
  ],
  coda: {
