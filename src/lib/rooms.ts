 ...
 * cobalt gallery language, but each room carries its own accent and one quiet
...
export const ROOM_THEMES: Record<RoomId, RoomTheme> = {
  garden: {
    accentVar: 'var(--cobalt)',
    motif: 'The shared gallery — limestone, cobalt, quiet grain.',
  },
  'do-it': {
    accentVar: 'var(--cobalt)',
    motif: '钴蓝闸门与秩序 — ordered cobalt hairlines at the margins.',
  },
  alaya: {
    accentVar: 'var(--moss)',
  ...
  'write-right': {
    accentVar: 'var(--cobalt-deep)',
    motif: '纸张与墨迹 — paper wash with a cobalt ink blot in the corner.',
  },
  sentinel: {
    accentVar: 'var(--dai)',
